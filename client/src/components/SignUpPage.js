...
export default function SignupPage() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch('https://gt-api-wine.vercel.app/signup', {
        method: 'POST',
  ...
  async function sendOtp(email) {
    emailErrorEle.textContent = "";
    try {
      const response = await fetch('https://gt-api-wine.vercel.app/getotp', {
        method: 'POST',
  ...
  async function verifyOtp(otp) {
    try {
      const response = await fetch('https://gt-api-wine.vercel.app/verifyotp', {
        method: 'POST',
